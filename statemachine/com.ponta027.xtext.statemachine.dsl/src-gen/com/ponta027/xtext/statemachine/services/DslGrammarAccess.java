...
* generated by Xtext
*/
package com.ponta027.xtext.statemachine.services;
...
public class DslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StatemachineElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cInitialStateStateIDTerminalRuleCall_3_1_0_1 = (RuleCall)cInitialStateStateCrossReference_3_1_0.eContents().get(1);
		...
		////TODO:SubStateを作る
		//Statemachine:
		//	{Statemachine} ("events" events+=Event+ "end")? ("resetEvents" resetEvents+=[Event]+ "end")? //初期状態
		//	("initialState" initialState=[State] "end")? ("commands" commands+=Command+ "end")? state+=State*;
		...
		//("initialState" initialState=[State] "end")?
		...
		//ID
		public RuleCall getInitialStateStateIDTerminalRuleCall_3_1_0_1() { return cInitialStateStateIDTerminalRuleCall_3_1_0_1; }
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cActionsCommandCrossReference_2_1_0 = (CrossReference)cActionsAssignment_2_1.eContents().get(0);
		private final RuleCall cActionsCommandIDTerminalRuleCall_2_1_0_1 = (RuleCall)cActionsCommandCrossReference_2_1_0.eContents().get(1);
		...
		private final Assignment cSubStateAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cSubStateStateParserRuleCall_4_0 = (RuleCall)cSubStateAssignment_4.eContents().get(0);
		private final Keyword cEndKeyword_5 = (Keyword)cGroup.eContents().get(5);
		
		//State:
		//	"state" name=ID ("actions {" actions+=[Command]+ "}")? transitions+=Transition* subState+=State* "end";
		public ParserRule getRule() { return rule; }
		...
		//[Command]
		public CrossReference getActionsCommandCrossReference_2_1_0() { return cActionsCommandCrossReference_2_1_0; }

		//ID
		public RuleCall getActionsCommandIDTerminalRuleCall_2_1_0_1() { return cActionsCommandIDTerminalRuleCall_2_1_0_1; }
		...
		//subState+=State*
		public Assignment getSubStateAssignment_4() { return cSubStateAssignment_4; }

		//State
		public RuleCall getSubStateStateParserRuleCall_4_0() { return cSubStateStateParserRuleCall_4_0; }
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("com.ponta027.xtext.statemachine.Dsl".equals(grammar.getName())) {
				return grammar;
			}
